...
public class APotions {
    ...
    static {
        ...
        Burning = POTIONS.register("burning", () -> new Potion(new MobEffectInstance(AEffects.Burning.get(),900,0)));
        LongBurning = POTIONS.register("long_burning", () -> new Potion(new MobEffectInstance(AEffects.Burning.get(),1800,0)));
        StrongBurning = POTIONS.register("strong_burning", () -> new Potion(new MobEffectInstance(AEffects.Burning.get(),450,1)));

        Shocked = POTIONS.register("shocked", () -> new Potion(new MobEffectInstance(AEffects.Shocked.get(),900,0)));
        LongShocked = POTIONS.register("long_shocked", () -> new Potion(new MobEffectInstance(AEffects.Shocked.get(),1800,0)));
        StrongShocked = POTIONS.register("strong_shocked", () -> new Potion(new MobEffectInstance(AEffects.Shocked.get(),450,1)));
