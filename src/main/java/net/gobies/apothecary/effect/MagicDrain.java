...
public class MagicDrain extends MobEffect {
    ...
    private static final ResourceLocation MAGIC_DAMAGE_KEY = ResourceLocation.fromNamespaceAndPath("apothecary", "effect.magic_drain.magic_damage");

    @Override
    public void createModifiers(int amplifier, @NotNull BiConsumer<Holder<Attribute>, AttributeModifier> consumer) {
        double magicDamage = CommonConfig.MAGIC_DRAIN_DECREASE.get();
