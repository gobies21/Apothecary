        ...
        if (entity != null && (Config.ENABLE_WORLD_EVENTS.get())) {
                    ...
                    if (entity.getArmorValue() > 0) {
                        ...
                        if (damageAmount > 3.0) {
                            ...
                            if (entity.getRandom().nextFloat() < 0.1) {
                                entity.addEffect(new MobEffectInstance(AEffects.RupturedArmor.get(), randomLongDuration, newAmplifier));
                            }
                        }
                    }
                }
                if (mob instanceof Mob && ((Mob) mob).isAggressive()) {
                    ...
                    if (entity.getRandom().nextFloat() < 0.05) {
                        entity.addEffect(new MobEffectInstance(AEffects.Feeble.get(), randomShortDuration, newAmplifier));
                    }
                }
                ...
                if (mob instanceof Witch) {
                    if (entity.getRandom().nextFloat() < 0.1) {
                        entity.addEffect(new MobEffectInstance(AEffects.Confusion.get(), randomShortDuration, 0));
                    }
                }
            }
        }
